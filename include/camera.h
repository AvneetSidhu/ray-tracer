...
class camera {
        ...
        void render(const hittable& world) {
            ...
            for (int j = 0; j < image_width; j ++) {
                ...
                for (int i = 0; i < image_width; i++ ) {
                    ...
                    auto ray_direction = pixel_centre - center;
    ...
    private:
        ...
        void initialize() {
            ...
            auto viewport_upper_left = center - vec3(0,0,focal_length) - viewport_u/2 - viewport_v/2; // vector for the upper left corner of the viewport
